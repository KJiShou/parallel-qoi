...
export type Frame = { step: number; burningCells?: number; burnedCells?: number; burnedPercentage?: number; cells?: number[]; cells2BitBase64?: string; lodRgbBase64?: string; hotspots?: Hotspot[] };
