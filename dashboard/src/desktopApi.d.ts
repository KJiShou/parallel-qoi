...
export type LiveTrace={schemaVersion:2;sourceRows:number;sourceCols:number;previewRows:500;previewCols:500;aggregationRows:number;aggregationCols:number;steps:number;density:number;seed:number;frames:{step:number;cells2BitBase64:string}[]};
