...
export type RunEvent={type:'started'|'trace-started'|'log'|'completed'|'failed'|'cancelled'|'trace-completed'|'trace-failed';runId:string;backend?:string;line?:string;stream?:'stdout'|'stderr';message?:string;result?:any;trace?:LiveTrace};
