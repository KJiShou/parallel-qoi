...
import { BACKEND_ORDER } from '../runConfig';
...
export function LiveRunPanel({ config, onConfig, selected, onSelected, onRun, onCancel, running, phase, log, desktop, completed, total, currentBackend }: Props) {
  ...
  return <section className="card live-panel">
    ...
    <p className="muted">Runs checked methods sequentially in the isolated order Serial → OpenMP → CUDA → MPI. A failed method does not stop the remaining selected methods.</p>
    ...
    <p className="fixed-settings">Fixed settings · 100 steps · 3 repetitions · seed 42 · OpenMP 4 threads · MPI 4 processes · CUDA block 256</p>
