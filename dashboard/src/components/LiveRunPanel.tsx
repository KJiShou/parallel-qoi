...
export function LiveRunPanel({ config, onConfig, selected, onSelected, onRun, onCancel, running, phase, log, desktop, completed, total, currentBackend }: Props) {
  ...
  return <section className="card live-panel">
    ...
    <p className="fixed-settings">Benchmark · 100 steps × 3 repetitions · seed 42 · OpenMP 4 threads · MPI 4 processes · CUDA block 256<br/>Playback · derived 5-second throughput · maximum 1000 visual steps</p>
