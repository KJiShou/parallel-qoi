...
type Props = { backend: BackendId; value: Parameters; onChange: (next: Parameters) => void }

export function ParameterPanel({ backend, value, onChange }: Props) {
  ...
  return <Space direction="vertical" size={12} className="parameter-panel">
    <Typography.Text type="secondary" className="eyebrow">Backend parameters</Typography.Text>
